...
const tools = [
  {
    ...
    items: [
      { slug: "wireshark", title: "Wireshark", desc: "Paket yakalamadan PCAP anomali tespiti ve zararlı yazılım analizi filtrelerine", level: "Başlangıç–İleri" },
    ],
  },
  {
    category: "Log Analizi",
    items: [
      { slug: "log-analysis", title: "Log Analizi", desc: "Nmap ve SQLMap saldırılarının Apache/Nginx loglarındaki izlerinin tespiti", level: "Orta" },
    ],
  },
];
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <p className="text-terminal-comment mb-8 ml-10">
        Tehditleri tespit et, ağ trafiğini analiz et ve loglardan saldırı izlerini oku.
      </p>
